...
type CollectorServiceClient interface {
	CollectorPosts(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Result, error)
}
...
type CollectorServiceServer interface {
	CollectorPosts(context.Context, *Empty) (*Result, error)
...
func (UnimplementedCollectorServiceServer) CollectorPosts(context.Context, *Empty) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CollectorPosts not implemented")
}
...
func _CollectorService_CollectorPosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollectorServiceServer).CollectorPosts(ctx, in)
	}
...
var CollectorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CollectorPosts",
			Handler:    _CollectorService_CollectorPosts_Handler,
		},
	},
